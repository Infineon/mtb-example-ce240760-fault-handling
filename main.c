...
* File Name:   main.c
*
* Description: This is the source code for the Fault Handling Example
*              for ModusToolbox.
*
    ...
    for (;;)
    {
        ...
        if (cmd != 0xff)
        {
            ...
            if (CMD_USAGE_FAULT == cmd)
            {
                ...
                {
                    printf("\rFailed to create CM7 Usage"\
                           " Fault!\r\n");
                }
...
{
    /* If Bus Fault valid or MemManage fault bit is set to 1, print Bus Fault or Usage Fault Address */
